    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-600 mt-2">
          Your booking has been successfully processed. We can't wait to welcome you to Windermere Lodges!
        </p>
      </div>
      ...
      <Card>
          ...
          <div className="space-y-4">
            {bookingDetails.lodge && (
              <div className="flex flex-col md:flex-row md:items-start md:justify-between">
                <div className="mb-2 md:mb-0">
                  <h3 className="font-semibold text-lg">{bookingDetails.lodge.name}</h3>
                ...
                <div className="bg-gray-100 rounded p-3">
                  <p className="text-sm">
                    Check-in: <span className="font-medium">From 4:00 PM</span>
                  </p>
                  <p className="text-sm">
            ...
            {bookingDetails.contactInfo && (
              <div>
                ...
                <p>
                  {bookingDetails.contactInfo.firstName} {bookingDetails.contactInfo.lastName}
                </p>
            ...
            <div>
              ...
              <div className="space-y-1 text-sm">
                <div className="flex justify-between">
                  ...
                  <span>£{bookingDetails.lodge ? bookingDetails.lodge.price * bookingDetails.nights : 0}</span>
                </div>
                ...
                {bookingDetails.discountApplied && (
                  <div className="flex justify-between text-green-600">
                    ...
                    <span>
                      -£
                      {Math.round(bookingDetails.lodge ? bookingDetails.lodge.price * bookingDetails.nights * 0.2 : 0)}
                    </span>
                  </div>
                )}
                    ...
                    {bookingDetails.lodge
                      ? Math.round(
                          bookingDetails.lodge.price * bookingDetails.nights +
                            (bookingDetails.extras?.reduce((sum: number, item: any) => sum + item.price, 0) || 0) +
                            bookingDetails.lodge.price * bookingDetails.nights * 0.2 -
                            (bookingDetails.discountApplied
                              ? bookingDetails.lodge.price * bookingDetails.nights * 0.2
                              : 0),
                        )
        ...
        <CardFooter className="flex flex-wrap gap-2">
          <Button variant="outline" className="flex items-center" onClick={generatePdf}>
            <Download className="mr-2 h-4 w-4" />
            Download Confirmation
          </Button>
          <Button variant="outline" className="flex items-center" onClick={addToCalendar}>
            <Calendar className="mr-2 h-4 w-4" />
            Add to Calendar
          </Button>
          <Button variant="outline" className="flex items-center" onClick={contactSupport}>
          ...
          <ol className="space-y-4">
            <li className="flex">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We've sent a confirmation email to {bookingDetails.contactInfo?.email || "your email address"} with
            ...
            <li className="flex">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Check out our{" "}
                  <a href="/activities" className="text-teal-600 hover:underline">
                    activities page
                  </a>{" "}
            ...
            <li className="flex">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Directions and check-in instructions will be sent to you 3 days before your arrival date.
                </p>
              </div>
            </li>
          </ol>
