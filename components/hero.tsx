    ...
    <div ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center" ref={textRef}>
        <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
          Experience Luxury in the Heart of the Lake District
        </h1>
        <p className="text-xl md:text-2xl text-white mb-8 max-w-3xl mx-auto">
          Discover our exclusive collection of premium lodges with breathtaking views and exceptional amenities
        </p>
